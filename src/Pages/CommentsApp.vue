    ...
    <div class="container">
       ...
       <ul class="list">
        <li v-for="(item , index) in posts" :key="index">
          ...
          <p> Name : {{ item.name }}</p>
          <strong> <span class="text-danger"> Comments :</span> {{ item.body }}</strong>
        </li>
       </ul>
       <div class="row">
...
const getPosts = ()=>{
    axios.get(`https://jsonplaceholder.typicode.com/comments?_page=${pagination.value}&_limit=${count.value}`).then((res)=>{
